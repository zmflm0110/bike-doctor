...
## 왜 만들었나
- **시작한 이유** — 따릉이 고장 신고는 매년 10만 건이 넘지만([헤럴드경제](https://biz.heraldcorp.com/article/10878875)), 고장 자전거를 만난 사람 대부분은 신고하지 않고 반납한 뒤 옆 자전거를 빌린다. 신고는 귀찮으니까. 그 자전거는 '대여 가능' 으로 남아 다음 사람을 기다린다.
- **목적** — 이용자는 빌리기 전에 피하고, 정비는 신고보다 먼저(중앙값 20~25시간), 신고되지 않을 고장(49~61%)까지 찾는다.
- **의의** — 사람에게 할 일을 늘리지 않고, 이미 공개된 "빌리자마자 반납" 기록을 읽는다. 새 장비·센서 없이 어느 도시의 공공자전거에도, 충전기 같은 다른 공유 시설에도 옮길 수 있다.

## 누구에게 도움이 되나
(측정 = 실제 기록으로 잰 것 · 재는 중 · 가능성)

| 누구 | 어떤 도움 | 근거 |
|---|---|---|
| 출근·통학하는 직장인과 학생 | 급한 아침에 고장 자전거로 헛걸음하지 않음 — 서울 하루 90~243명을 막을 수 있었음 | 측정 |
| 처음 타 보는 사람 | 고장인지 내가 서툰 건지 모를 때 "앞사람들도 바로 반납" 이 판단을 대신 | 가능성 |
| 관광객·외국인, 어르신 | 앱 신고가 어려워도 번호만 넣으면 됨, 아무도 신고하지 않아도 고장이 드러남 | 가능성 |
| 정비 기사 | 신고보다 20~25시간 먼저, 끝내 신고되지 않을 고장(49~61%)까지 · 경보의 절반이 대여소 16% 에 몰려 도는 순서가 나옴 | 측정 |
| 서울시설공단·서울시 | 새 장비·비용 없이 신고에 기대지 않는 고장 현황판, 헛걸음·민원 감소 | 가능성 |
| 구조대(시민 참여) | 지나가다 3초 확인 → 확인된 곳이 정비 순위 맨 위로 | 가능성 |
| 다른 도시 공공자전거 | 대전 타슈에 서울 기준 그대로 적용해 확인(다음 사람 41.6~43.6% 포기), 세종·창원도 대여기록만 있으면 | 대전 측정 |
| 전기차 운전자 | 앱엔 '사용 가능' 인데 안 되는 충전기 피하기 — 서울 충전기 수집 첫날 끝난 충전의 8.2% 가 3분 안에 끊김 | 재는 중 |
| 공유 킥보드·자전거 회사 | 자기 대여기록에 같은 원리 | 가능성 |
| 학생·연구자 | 코드·자료 모두 공개, 그대로 다시 만들어 볼 수 있음 | 공개 |
