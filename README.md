...
| 누구 | 어떤 도움 | 근거 |
|---|---|---|
| 출근·통학하는 직장인과 학생 | 급한 아침에 고장 자전거로 헛걸음하지 않는다 — 서울 하루 90\~243명을 막을 수 있었다 | 측정 |
| 정비 기사 | 신고보다 20\~25시간 먼저, 끝내 신고되지 않을 고장까지. 경보의 절반이 대여소 16% 에 몰려 도는 순서가 나온다 | 측정 |
| 다른 도시 공공자전거 | 대전 타슈에 서울 기준을 그대로 적용해 확인했다. 세종·창원도 대여기록만 있으면 된다 | 대전 측정 |
| 처음 타 보는 사람 · 관광객 · 어르신 | 고장인지 모를 때, 앱 신고가 어려울 때 — 번호만 넣으면 되고, 아무도 신고하지 않아도 고장이 드러난다 | 가능성 |
| 서울시설공단 · 서울시 | 새 장비·비용 없이 신고에 기대지 않는 고장 현황판 | 가능성 |
| 구조대(시민 참여) | 지나가다 3초 확인 → 확인된 곳이 정비 순위 맨 위로 | 가능성 |
| 전기차 운전자 | 앱엔 '사용 가능' 인데 안 되는 충전기 — 서울 충전기 수집 첫날 끝난 충전의 8.2% 가 3분 안에 끊겼다 | 재는 중 |
...
| 전기차 충전기로 넓히기 | 🟢 수집 중 — 1\~2주 모은 뒤 검증 |
